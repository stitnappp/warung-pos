...
import { X, Banknote, CreditCard, QrCode, Printer, MapPin } from 'lucide-react';
...
export function CheckoutDialog({
  ...
  const handleComplete = () => {
    ...
    // Langsung proses dan cetak tanpa menampilkan struk
    setTimeout(() => {
      const finalAmountPaid = paymentMethod === 'cash' ? amountPaid : total;
      onComplete(paymentMethod, finalAmountPaid);
